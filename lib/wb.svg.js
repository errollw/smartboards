function place_img_in_svg($m_d, img_src, svg_wrapper){
    ...
    // TODO: include ability to rotate images?
    //image = ... img_src, {transform: 'rotate(45,{0},{1})'.f(pos.x+size.w/2, pos.y+size.h/2)});
...
function svg_img_click_handler($wb_pane){
    ...
    return function() {
        ...
        $movable_drawing = make_movable_drawing(img_src, image_box, parent_rect, $wb_pane, svg_wrapper);
