...
function place_img_in_svg($m_d, img_src, svg_root){
    ...
    svg_image.setAttribute('x', pos.x); 
    svg_image.setAttribute('y', pos.y);
    svg_image.setAttribute('width', size.w);
    svg_image.setAttribute('height', size.h);
...
function upload_svg(u_id, svg_root){
    ...
    svg_output = svg_clone_shim.html();
