...
var PEN_OPTION_SIZE_RATIO = 0.06,
    PEN_OPTION_TOGGLE_RATIO = 0.08,
...
function resize_canvas_opts(container_width){
    ...
    $('.pen-option.pen-size').each(function(){
        ...
        $('.pen-size-dot', $(this)).css({
            ...
            boxShadow: PEN_SIZE_DOT_SHADOW_FMT.f($(this).width()*0.04)
        });
    });

    $('.pen-option.color').css('box-shadow',PEN_OPTION_COLOR_SHADOW_FMT.f(container_width * 0.004));
