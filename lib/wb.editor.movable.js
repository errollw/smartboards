...
function make_movable_drawing(image_URL, image_box, p_rect, $wb_pane){
    ...
    if (image_box.height == 0 || image_box.width == 0){
        ...
        img.onload = function() {
            ...
            // Only center image after finding out dimensions
    ...
    $.extend($m_d, {
        ...
        start_resizing: function($ctrl_pt, $counter_pt){
            ...
            resize_diag = $ctrl_pt.offset().left != anchor_pt.x && $ctrl_pt.offset().top != anchor_pt.y;
        ...
        resize_to: function(mouseX, mouseY){
            ...
            $m_d.offset({
                ...
                left: anchor_pt.x - anchor_x_rat*$m_d.width()
            });
        },
